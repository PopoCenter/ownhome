...
public interface TeamMemberMapper extends BaseMapper<TeamMemberEntity> {
    ...
    @Select("select u.phone as phone, u.name as name, m.member_role as role from t_team_member as m left join t_user as u on m.member_id=u.user_id where team_id = #{teamId} order by m.create_time desc ")
